...
public:
  ...
  EvalsResource& evals() { return evals_; }
  const EvalsResource& evals() const { return evals_; }
...
private:
  ...
  friend class EvalsResource;
  friend class EvalsRunsResource;
  friend class EvalsRunsOutputItemsResource;
